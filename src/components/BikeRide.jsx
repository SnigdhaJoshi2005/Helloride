...
const bikeStats = [
  { icon: "bolt", value: "3 min", label: "Avg wait time", mobileValue: "2 min", delay: "0ms", x: "-30px", y: "-20px" },
  ...
  { icon: "fare", value: "NPR 50", label: "Starting fare", mobileValue: "NRP 50", mobileLabel: "Starting Price", delay: "600ms", x: "10px", y: "-30px" },
];
